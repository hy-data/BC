		...
		<form action="menu/editicon.do" name="menuForm" id="menuForm" method="post">
			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<tr>
					...
					<td><label onclick="seticon('icon-check');"><input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl">&nbsp;<i class="icon-check"></i></span></label></td>
				</tr>
				<tr>
					...
					<td><label onclick="seticon('icon-group');"><input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl">&nbsp;<i class="icon-group"></i></span></label></td>
				</tr>
				<tr>
