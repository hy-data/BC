...
//      QueryResponse response = server.query(params);
        ...
        query.setQuery("dataContent:谷歌  dataTitle:谷歌");
//        query.setQuery("四次会");
        query.setFields("id","dataContent","dataTitle","createDate","createUid","score");
//        query.setSort("createDate", ORDER.desc);
        query.setStart(0);
        query.setRows(20);
//        query.set("shards", "localhost:8080/solr/api,localhost:8080/solr/blog");
//      query.setRequestHandler("/select");
        ...
        for (SolrDocument doc : response.getResults()) {
            ...
            System.out.println("dataTitle: "
                    + doc.getFieldValue("dataTitle").toString());
//            System.out.println("dataContent: " + doc.getFieldValue("dataContent"));
            System.out.println("createUid: " + doc.getFieldValue("createUid"));
