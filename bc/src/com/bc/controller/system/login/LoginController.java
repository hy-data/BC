package com.bc.controller.system.login;
...
import com.bc.entity.system.Menu;
...
import com.bc.util.RightsHelper;
		...
		try{
			...
			if (user != null) {
				...
				if(null == session.getAttribute(Const.SESSION_QX)){
					System.out.println("this.getUQX(session):"+this.getUQX(session));
